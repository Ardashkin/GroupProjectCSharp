...
namespace Shop.DAL.Repository
{
         ...
         where TEntity : class, new()
    {
        ...
        {
            dbContext = Activator.CreateInstance(typeof(Shop)) as Shop;
        }
        ...
        public IQueryable<TEntity> Query(Expression<Func<TEntity, bool>> predicate = null, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>> orderBy = null)
        {
